...
designation:z.string({required_error:'designation  is required'}),
 ...
 bloodgroup : z.enum(bloodGroupValues,{required_error:"blood group is requried"}),
 presentaddress:z.string({required_error:'present address is required'}),
permanentaddress: z.string({required_error:'permanent present address is required'}),
